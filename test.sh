...
try 5 'int main () { return plus(2,3); } int plus(int x,int y) { return x+y; }'
try 1 'int main () { return fib(1); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 2 'int main () { return fib(2); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 3 'int main () { return fib(3); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 5 'int main () { return fib(4); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 8 'int main () { return fib(5); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 13 'int main () { return fib(6); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 21 'int main () { return fib(7); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 34 'int main () { return fib(8); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
try 55 'int main () { return fib(9); } int fib (int n){ if (n < 2) return 1; else return fib(n-1) + fib(n-2); }'
